...
<head>
    ...
    <div>
        ...
        <h5><a href="WatchListALL.jsp">Show All</a></h5>
        <h5><a href="WatchListByMechanical.jsp">просмотр списка механических часов</a></h5>
    ...
    <table class="content-table">
        ...
        <% WatchDAO manufacturerDAO = new WatchDAOImplementation();
            List<Watch> watches = manufacturerDAO.selectAllWatch();
